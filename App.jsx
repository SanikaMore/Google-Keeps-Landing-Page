...
function App() {
  ...
  return (
   <div className="min-h-screen flex flex-col text-white">
     ...
     <footer className="container mx-auto p-6 flex flex-col md:flex-row itwms-centre justify-between">
        <p>
          Build with by sanika
        </p>

        <div className="flex -mx-6">
          <a href="#" className="mx-3 hover:opacity-80 duration-150">About US</a> |
          <a href="#" className="mx-3 hover:opacity-80 duration-150">Privacy</a>|
          <a href="#" className="mx-3 hover:opacity-80 duration-150">Conatct</a>
        </div>
     </footer>
   </div> 
  )
